...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "eat the things as a snake and don't run into yourself";
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_DOWN:
			...
			System.out.println("aiohrjoaerwthawruh");
			break;
		case KeyEvent.VK_UP:
	...
	private void setFoodLocation() {
		...
		int x = rando.nextInt(15);
		int y = rando.nextInt(12);
		...
		foodLocation = l;
		//agh
		if(snake.isLocationOnSnake(l) == true) {
			l = new Location(rando.nextInt(15), rando.nextInt(12));
		}
	}

	private void gameOver() {
		Random rando = new Random();
		Location gah = new Location(rando.nextInt(15), rando.nextInt(12));
		//1. stop the timer
		timer.stop();
		//2. tell the user their snake is dead
		JOptionPane.showMessageDialog(null, "you died!");
		//3. ask them if they want to play again.
		String p = JOptionPane.showInputDialog("Do you want to play again?").toLowerCase();
	...
	public void actionPerformed(ActionEvent e) {
		Location i = snake.getHeadLocation();
		//1. update the snake
		snake.update();
